...
const KursWLiczbach = ({ items }: { items: KursWLiczbachItem[] }) => {
  return (
    <HomeSection className="flex flex-col justify-start md:justify-between items-start md:gap-4 gap-0 bg-eblue py-28 px-8 md:px-6 md:px-24 md:py-12 font-outfit text-butter-100">
